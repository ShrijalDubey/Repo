    ...
    <>
      <div className="editor-nav-cont">
        ...
        <div className="rightnav">
          ...
          <button className="edit-button"><i className="fa-solid fa-floppy-disk"></i> Save</button>
          <button style={{ backgroundColor: "rgba(11, 187, 1, 1)" }} className="edit-button"><i className="fa-solid fa-play"></i> Run</button>
        </div>
      </div>
      <CodeEditor />
    </>
