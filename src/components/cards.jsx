...
export default function Cards() {
  return (
    ...
    <div className='mid-body'>
        ...
        <p className='sub-para'><i style={{color:"rgba(11, 187, 1, 1)"}} class="fa-solid fa-circle-check"></i> No setup required. Write code and see results immediately with our powerful execution engine.</p>
        <p className='sub-para'><i style={{color:"rgba(11, 187, 1, 1)"}} class="fa-solid fa-circle-check"></i> Practice DSA concepts with real code, not just theory. Build muscle memory through repetition.</p>
        <p className='sub-para'><i style={{color:"rgba(11, 187, 1, 1)"}} class="fa-solid fa-circle-check"></i> Clear error messages, starter templates, and an intuitive interface designed for learners.</p>
        <p className='sub-para'><i style={{color:"rgba(11, 187, 1, 1)"}} class="fa-solid fa-circle-check"></i> Cloud-based platform accessible from any device. Your code is always saved and secure.</p>
        <p className='sub-para'><i style={{color:"rgba(11, 187, 1, 1)"}} class="fa-solid fa-circle-check"></i> Showcase your best work to the community and potential employers.</p>
    </div>
    </div>
    </>
  );
